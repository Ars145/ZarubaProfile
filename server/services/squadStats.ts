...
interface SquadStatsRaw {
  ...
  roles: Record<string, number>; // role -> minutes
  weapons: Record<string, number>; // weapon -> kills
  possess: Record<string, number>; // vehicle -> seconds
  scoreGroups: Record<string, number>; // group -> score
}
